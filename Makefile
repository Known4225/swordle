...
lib:
	...
	gcc turtlelib.c -c -DTURTLE_IMPLEMENTATION -DTURTLE_TEXT_DO_DYNAMIC_Y_CENTERING -DTURTLE_TEXT_PRETTY_PEN -DTURTLE_ENABLE_TEXTURES -DTURTLE_ENABLE_SERIAL -DTURTLE_ENABLE_SOCKETS -DTURTLE_ENABLE_CAMERA -DOS_LINUX -O3 -o Linux/libturtle.a
	rm turtlelib.c
win:
...
winlib:
	cp turtle.h turtlelib.c
	gcc turtlelib.c -c -DTURTLE_IMPLEMENTATION -DTURTLE_TEXT_DO_DYNAMIC_Y_CENTERING -DTURTLE_TEXT_PRETTY_PEN -DTURTLE_ENABLE_TEXTURES -DTURTLE_ENABLE_SERIAL -DTURTLE_ENABLE_SOCKETS -DTURTLE_ENABLE_CAMERA -DOS_WINDOWS -O3 -o Windows/turtle.lib
	rm turtlelib.c